...
from CropPrice import MyDialog,Ui_Dialog
from webScrapping import weatherApp
from PIL import Image,ImageTk;
from test import garlic_info
import datetime
...
class DashBoard:
     ...
     def __init__(self,root):
            ...
            btn_1 = customtkinter.CTkButton(master=root, image=add_image_s1, text="Weather Forecast", width=220, height=80,
                                            compound=TOP, border_color='black', border_width=3,command=self.weather_details)
            ...
            btn_2 = customtkinter.CTkButton(master=root, image=add_image_s2, text="Schemes & Magazines", width=220,
                                            height=80,
                                            compound=TOP, border_color='black', border_width=3,command=self.garlic_details)
            ...
            btn_5 = customtkinter.CTkButton(master=root, image=add_image_s5, text="Crop Market Prices", width=220,
                                            height=80,
                                            compound=TOP, border_color='black', border_width=3,command=self.cropprice_details)
     ...
     def weather_details(self):
         self.new_window=Toplevel(self.root)
         self.app = weatherApp(self.new_window)

     def cropprice_details(self):
         self.new_window = Toplevel(self.root)
         self.app = MyDialog(self.new_window)
