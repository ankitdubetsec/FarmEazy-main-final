...
button1 = tk.Button(button_frame, text="Home", command=go_home,bg="#badc57", fg="black", padx=10, borderwidth=0, highlightthickness=0,font='Helvetica 14 bold')
...
area_label = tk.Label(frame, text="Area(acres)", bg="#badc57" ,font='Helvetica 18 bold',fg="black")
area_label.place(relx=0.04, rely=0.2, relheight=0.1)
